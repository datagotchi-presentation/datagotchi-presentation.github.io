...
- Transforming Data Collection Through AI Conversations
  ...
  - **Unstructured Data Capture**: Analyzes semantics, vocabulary, and tone.
  - **Real-Time Education**: AI explains questions, clarifies terms, and contextualizes responses.

**Status**: In active development


## From Forms to Conversation {.smaller}
...
- **Chatbot**
  - Reverses the typical chatbot paradigm: asks questions instead of answering them
  - Guides users through conversational dialogue to collect opinions
...
- **Current public consultation challenges**
  ...
  * Limited reach of traditional approaches (focus groups, roundtables, etc.)
...
3. **Focus groups enhanced by the chatbot**
4. **Expert group meeting**

::: {.notes}
First we'll develop an AI-based conversational agent, accessible and intuitive for all participants. This will allow us to collect and analyze contributions at scale. We'll then conduct a systematic literature review to identify best practices in citizen deliberation and challenges specific projects. We'll facilitate three deliberative workshops in Mexico, using the conversational agent as a mediator. Finally, we'll analyze the results and recommendations, validate use cases prioritized by citizens, and develop an ethical and inclusive deployment framework.
:::
