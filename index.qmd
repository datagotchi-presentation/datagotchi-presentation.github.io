...
## Voici le lien vers la présentation : {.center .smaller} 

`https://capel201.github.io`
...
- Beaucoup de tutoriels orientés vers les sciences sociales et autres!
  - Datacamp
  - Coursera
  - Datanovia

#### Bref... important d'utiliser R
...
## Analyse rapide d'une variable{.smaller}
...
## Filter et sélectionner des variables{.smaller}
...
- Commencer en noir et blanc 
  - Utilisez les couleurs de manière efficace
...
## Organiser votre environnement de travail{.smaller}
