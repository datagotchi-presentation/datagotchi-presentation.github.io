...
![](img/datagotchi_amis.png){.absolute top=450 left=300 width="470" height="300"}
...
- **Analysis based on literary preferences**
  - Predict favorite genres 
  - Provide personalized recommendations

- **Implement innovative access features**
...
- **Predicting well-being levels**
  * Based on habits, workplace environment, sleep quality & many more variables
